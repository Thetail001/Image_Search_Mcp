...
read -p "请输入默认引擎 (Yandex/BaiDu/All): " NEW_DEFAULT_ENGINE
IMAGE_SEARCH_DEFAULT_ENGINE=${NEW_DEFAULT_ENGINE:-${IMAGE_SEARCH_DEFAULT_ENGINE:-Yandex}}
...
IMAGE_SEARCH_DEFAULT_ENGINE=${IMAGE_SEARCH_DEFAULT_ENGINE}
EOF
